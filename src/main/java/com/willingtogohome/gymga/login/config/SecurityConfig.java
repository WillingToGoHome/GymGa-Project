...
public class SecurityConfig {
    ...
    public SecurityFilterChain configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests( auth -> {
            ...
            auth.requestMatchers("/", "/main", "/main/**","/emp/**","/fac/**","/pass/**","/sale/**","/schedule/**","/user/**","/imageFile/**","/api/loggedInUser","pain/**").hasAnyAuthority(UserRole.ADMIN.getRole(), UserRole.USER.getRole());
