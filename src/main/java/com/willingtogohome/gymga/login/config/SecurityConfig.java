...
public class SecurityConfig {
    ...
    public SecurityFilterChain configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests( auth -> {
            ...
            auth.requestMatchers("/main", "/emp/**", "/fac/**","/pass/**","/sale/**","/schedule/**","/user/**","/pain/**","/imageFile/**","/api/loggedInUser").hasAnyAuthority(UserRole.ADMIN.getRole(), UserRole.USER.getRole());
